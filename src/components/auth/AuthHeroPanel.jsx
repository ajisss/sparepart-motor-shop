  ...
  return (
    <div className="relative flex h-full w-full flex-col justify-between overflow-hidden rounded-2xl bg-primary-100 p-6">
      <svg
        ...
        aria-hidden="true"
      >
        <circle cx="392" cy="70" r="220" className="fill-secondary-200" fillOpacity="0.7" />
      ...
      <div className="relative z-10 flex items-center justify-between">
        <span className="inline-flex items-center rounded-lg bg-neutral-0 px-3 py-2 shadow-sm">
          <img src={logo} alt="DMB Moto Shop" className="h-8 w-auto" />
        </span>
      </div>
